...
Uma análise da linguagem foi feita considerando diversos aspectos, como usabilidade, simplicidade, tipos de dados, entre outros (notas de um a dez, sendo dez excelente e um péssimo, vide tabela na última página).
\begin{table}[!h]
	\begin{tabular}{|l|l|l|}
		\hline
