...
\begin{table}[h!]
	\begin{tabular}{|l|l|l|}
		...
		Checagem de tipos & 7 & \begin{tabular}[c]{@{}l@{}}Possui tipagem estática por padrão, \\ para tipagem dinâmica utilizar\\ cláusula \textbackslash{}textit\{virtual\}\end{tabular} \\ \hline
		...
		Suporte ao tratamento de exceções & 7 & \begin{tabular}[c]{@{}l@{}}Não possui um sistema tão robusto \\ quanto Java, por exemplo, não contendo\\ cláusulas \textbackslash{}textit\{finally\}, por exemplo\end{tabular} \\ \hline
