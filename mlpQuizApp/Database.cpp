...
Database::Database()
{
        ...
        questions.push_back(new Question("Quais as três características essenciais de uma linguagem orientada a objetos?", "Herança, Portabilidade e Coesão", "Polimorfismo, Herança e Acoplamento", "Encapsulamento, Herança e Polimorfismo", "Vínculo estático, vínculo dinâmico e polimorfismo", 2));

        questions.push_back(new Question("Em \"R\", dado o segmento de código: \nlibrary(functional)\nmult <- function\n"
